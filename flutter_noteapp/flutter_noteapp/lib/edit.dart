...
//Http to get detail data
  Future _getData() async {
    try {
      final response = await http.get(Uri.parse(
          ...
          "http://172.18.0.24/latihan/note_app/detail.php?id='${widget.id}'"));
  ...
  Future _onUpdate(context) async {
    try {
      return await http.post(
        Uri.parse("http://172.18.0.24/latihan/note_app/update.php"),
        body: {
          "id": widget.id,
          "title": title.text,
  ...
  Future _onDelete(context) async {
    try {
      return await http.post(
        Uri.parse("http://192.168.1.6/latihan/note_app/delete.php"),
        body: {
          "id": widget.id,
        },
      ).then((value) {
